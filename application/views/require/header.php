...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/assets/css/font-awesome-n.min.css')?>">

<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/assets/pages/jquery.filer/css/jquery.filer.css')?>">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/assets/pages/jquery.filer/css/themes/jquery.filer-dragdropbox-theme.css')?>">
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/assets/css/widget.css')?>">
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/bower_components/swiper/css/swiper.min.css')?>">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/bower_components/owl.carousel/css/owl.carousel.css')?>">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/bower_components/owl.carousel/css/owl.theme.default.css')?>">


<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/assets/css/dropzone.css')?>">
